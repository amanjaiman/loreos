...
- [architecture.md](architecture.md) — the one-behavior-layer / thin-shim model
  and the invariants that keep Lore trustworthy.
- [privacy.md](privacy.md) — the closed network-egress list and where your data
  lives.
