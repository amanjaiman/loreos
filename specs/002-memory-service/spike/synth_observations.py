...
ANCHORS: list[Obs] = [
    ...
    Obs(
        "a1",
        "The user's main code editor is Visual Studio Code.",
        "preferences",
        dedup_group="editor",
        tags=["editor"],
    ),
    Obs(
        "a2",
        "User spends most of their coding time inside VS Code.",
        "preferences",
        dedup_group="editor",
        tags=["editor"],
    ),
    Obs(
        "a3",
        "Observed the user editing files in Visual Studio Code again today.",
        "preferences",
        dedup_group="editor",
        tags=["editor"],
    ),
    ...
    Obs(
        "a4",
        "The user has switched their primary editor from VS Code to Neovim.",
        "preferences",
        contradicts="a1",
        tags=["editor"],
    ),
    ...
    Obs(
        "b2",
        "User mentioned being based in Seattle, Washington.",
        "personal",
        dedup_group="city",
        tags=["location"],
    ),
    ...
    Obs(
        "b3",
        "The user is relocating to Austin, Texas next month.",
        "personal",
        contradicts="b1",
        tags=["location"],
    ),
    ...
    Obs(
        "c1",
        "The Memory Service spec (002) is due for review by June 20.",
        "work",
        dedup_group="deadline002",
        tags=["deadline", "lore"],
    ),
    Obs(
        "c2",
        "User noted the 002 memory-service review deadline is June 20.",
        "work",
        dedup_group="deadline002",
        tags=["deadline", "lore"],
    ),
    ...
    Obs(
        "d2",
        "User selected the vegetarian option when ordering lunch.",
        "health",
        dedup_group="diet",
        tags=["diet"],
    ),
    Obs(
        "d3",
        "The user has started eating fish again and now describes themselves as pescatarian.",
        "health",
        contradicts="d1",
        tags=["diet"],
    ),
    ...
    Obs(
        "s1",
        "The user booked a flight to Tokyo departing March 14 on United Airlines.",
        "travel",
        tags=["travel", "flight"],
    ),
    ...
    Obs(
        "s4",
        "The user is learning to play the cello, practicing about 30 minutes a day.",
        "hobby",
        tags=["music", "learning"],
    ),
    ...
    Obs(
        "s6",
        "User's car is a 2019 Subaru Outback, due for an oil change at 60k miles.",
        "personal",
        tags=["car"],
    ),
    Obs(
        "s7",
        "The user is reading 'The Three-Body Problem' by Liu Cixin.",
        "hobby",
        tags=["reading"],
    ),
    Obs(
        "s8",
        "User pays for a Spotify Family plan shared with three relatives.",
        "finance",
        tags=["subscription"],
    ),
]
