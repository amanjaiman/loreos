...
The axes are still orthogonal under the hood (palette × style × mode), so you *can* mix them — but the two themes above are the supported, designed combinations.
...
- **Tone:** Declarative and unhurried. Short sentences. Confidence without exclamation. *"Memory, kept warm." · "Lore remembers so you don't have to." · "Nothing demands your attention until it earns it."*
...
- **Verbs:** Ambient, sensory, low-effort — *listen, surface, thread, recall, keep warm, remember, summon*. Avoid aggressive SaaS verbs (*supercharge, unlock, crush, leverage*).
...
- **System:** [**Lucide**](https://lucide.dev) — loaded from CDN (`https://unpkg.com/lucide@latest`). Chosen for its even **2px stroke, rounded caps/joins**, and large, consistent set, which match Lore's calm-precise feel. *This is a substitution* — no brand icon set was provided. → see CAVEATS.
